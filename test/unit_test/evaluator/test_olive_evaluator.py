...
from test.unit_test.utils import (
    ...
    get_custom_metric_onnx,
    get_custom_metric_openvino,
    get_custom_metric_pytorch,
    get_custom_metric_snpe,
    get_latency_metric,
...
class TestOliveEvaluator:
    ...
    def test_evaluate_custom_no_eval(self):
        ...
        with pytest.raises(ValueError, match="evaluate_func is not defined in user script"):
